            ...
            <div class="bg-white p-6">
                ...
                <div v-if="selectedTab === 'Report'" class="sm:mx-0 md:mx-8">
                    ...
                    <div v-else
                        ...
                        <p class="text-sm font-medium flex text-center">
                            When {{ user.firstname }} create a Reports about Strays or their Missing pets, they'll appear here.</p>
                ...
                <div v-if="selectedTab === 'Profile'" class="sm:mx-0 md:mx-8">
                    ...
                    <div v-else
                        ...
                        <p class="text-sm font-medium flex text-center">When {{ user.firstname }} create a pet profiles, they'll
                            appear here.</p>
                    </div>
                    <div>
                        <linkfooter />
