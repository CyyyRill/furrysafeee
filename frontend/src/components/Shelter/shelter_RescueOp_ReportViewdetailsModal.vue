                                            ...
                                            <div class="flex justify-center border-b pb-7">
                                                <dd class="flex flex-col justify-center gap-x-3 gap-y-1">
                                                    ...
                                                    <span :class="{
                                                        ...
                                                        'bg-amber-50 text-amber-600 border-amber-100': selectedReportDetails.report_status === 'Pending',
                                                        'bg-teal-50 text-teal-600 border-teal-100': selectedReportDetails.report_status === 'In progress'
                                                    }"
                                                    ...
                                                    <dl class="divide-y divide-gray-100">
                                                        <div
                                                            ...
                                                            <dd :class="{
                                                                ...
                                                                'text-teal-600': selectedReportDetails.report_status === 'In progress'
                                                            }" class="text-sm leading-6 font-bold text-gray-600 xl:col-span-2">
                                                        ...
                                                        <div
                                                            v-if="selectedReportDetails.report_status === 'In progress'">
                                                            <button class="w-full">
                                                                <statusbuttons />
                                                            </button>
                                                        </div>
